...
-- @Descripción:      Trigger para DOCUMENTAL en sclbd_s2
    ...
    WHEN INSERTING THEN
      ...
      ELSE
        ...
        IF v_count > 0 THEN
          ...
          -- Iserta BLOB en tabla temporal
          INSERT INTO ti_documental_2(programa_id, trailer)
          VALUES (:new.programa_id, :new.trailer);
          -- Inserción en fragmento 2
          INSERT INTO documental_f2
            SELECT t2.programa_id, :new.tematica, :new.duracion, t2.trailer,
              :new.pais_id
            FROM ti_documental_2 t2
            WHERE programa_id = :new.programa_id;
          -- Se limpia la tabla temporal
