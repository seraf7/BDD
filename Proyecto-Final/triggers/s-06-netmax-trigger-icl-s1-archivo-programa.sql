...
-- @Descripción:      Trigger para ARCHIVO_PROGRAMA en iclbd_s1
  ...
  CASE
    WHEN INSERTING THEN
      ...
      IF :new.tamanio > 10 THEN
        -- Inserción remota en fragmento 1
        -- Inserta BLOB en tabla temporal
        INSERT INTO ti_archivo_programa_1(num_archivo, programa_id, archivo)
        VALUES (:new.num_archivo, :new.programa_id, :new.archivo);
        -- Inserta en el sitio remoto
        INSERT INTO archivo_programa_f1
          SELECT :new.num_archivo, :new.programa_id, t1.archivo, :new.tamanio
          FROM ti_archivo_programa_1 t1
      ...
      ELSIF :new.tamanio BETWEEN 0 AND 10 THEN
        -- Inserción local en fragmento 2
