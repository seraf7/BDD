...
CREATE TABLE PROGRAMA_F2_ICL_S1(
    ...
    CONSTRAINT RefSTATUS_PROGRAMA11 FOREIGN KEY (STATUS_PROGRAMA_ID)
...
CREATE TABLE DOCUMENTAL_F2_ICL_S1(
    ...
    CONSTRAINT RefPAIS_R_ICL_S151 FOREIGN KEY (PAIS_ID)
    REFERENCES PAIS_R_ICL_S1(PAIS_ID),
    CONSTRAINT RefPROGRAMA_F2_ICL_S161 FOREIGN KEY (PROGRAMA_ID)
...
CREATE TABLE PELICULA_F2_ICL_S1(
    ...
    CONSTRAINT RefPROGRAMA_F2_ICL_S171 FOREIGN KEY (PROGRAMA_ID)
    REFERENCES PROGRAMA_F2_ICL_S1(PROGRAMA_ID)
)
;
...
CREATE TABLE USUARIO_F1_ICL_S1(
    ...
    CONSTRAINT PK11_1 PRIMARY KEY (USUARIO_ID)
)
;
...
CREATE TABLE PLAYLIST_F2_ICL_S1(
    ...
    CONSTRAINT RefPROGRAMA_F2_ICL_S1121 FOREIGN KEY (PROGRAMA_ID)
    REFERENCES PROGRAMA_F2_ICL_S1(PROGRAMA_ID),
    CONSTRAINT RefUSUARIO_F1_ICL_S1141 FOREIGN KEY (USUARIO_ID)
...
CREATE TABLE SERIE_F2_ICL_S1(
    ...
    CONSTRAINT RefPROGRAMA_F2_ICL_S191 FOREIGN KEY (PROGRAMA_ID)
    REFERENCES PROGRAMA_F2_ICL_S1(PROGRAMA_ID),
    CONSTRAINT RefTIPO_SERIE_R_ICL_S1101 FOREIGN KEY (TIPO_SERIE_ID)
...
CREATE TABLE USUARIO_F4_ICL_S1(
    ...
    CONSTRAINT RefTIPO_CUENTA_R_ICL_S1111 FOREIGN KEY (TIPO_CUENTA_ID)
